...
public class MarinaXML {
    ...
    public final static String update = "10";
...
//            if (args[0].equals("-gui")) {  // der Aufruf des JFileChoosers blockiert das setzen der NumerOfThreads // Peter 21.05.2024
...
//            }
            ...
            // Lesen
            try {
                JAXBContext jc = JAXBContext.newInstance( "de.smile.xml.marina" );
                Unmarshaller u = jc.createUnmarshaller();
                de.smile.xml.marina.Marina mcp = (de.smile.xml.marina.Marina)u.unmarshal(new FileInputStream(xml_file));
...
// ControlParameter
                ...
                if ((majornr*10+minornr)<30){
                    System.out.println("Achtung: Die in der XML-Steuerdatei spezifizierte Versionsnummer ist kleiner als Version 3.0!");
                    System.out.println("Bitte Ueberpruefen Sie, ob die XML-Steuerdatei dem aktuellen XML-Schema der Version 3.0 entspricht!");
                    System.exit(0);
                }
                ...
                if( controlParameter.getSystem().getTriangleMesh().getFileType() == TMeshFileType.SYS_DAT_FILE) {
                    feapp = TicadIO.readFESysDat(base_dir+controlParameter.getSystem().getTriangleMesh().getFileName());
                    feapp.initialMeanEdgeLength();
                } else if( controlParameter.getSystem().getTriangleMesh().getFileType() == TMeshFileType.JANET_BINARY_FILE) {
                    feapp = SmileIO.readFEDfromJanetBin(base_dir+controlParameter.getSystem().getTriangleMesh().getFileName());
                    feapp.initialMeanEdgeLength();
                }
                try{
                ...
                int numberOfThreads;
                try{
                    numberOfThreads = Math.min(controlParameter.getNumberOfThreads(),Runtime.getRuntime().availableProcessors());
                } catch(Exception ex){numberOfThreads = Runtime.getRuntime().availableProcessors();}
...
//--------------
                ...
                if( configuration.getMeteorologicalModel2D()!=null) {
                    ...
                    if(configuration.getMeteorologicalModel2D().getResultFile().getFileType() == TResultFileType.TICAD_SYS_ERG) {
                        meteorologydat.xferg_name=base_dir+configuration.getMeteorologicalModel2D().getResultFile().getFileName();
                    }
                    if(configuration.getMeteorologicalModel2D().getDataBased()!=null){
                        ...
                        if(configuration.getMeteorologicalModel2D().getDataBased().getWindTimeSeries()!=null){
                            metModel = new MeteorologicalModel2D(feapp, base_dir+configuration.getMeteorologicalModel2D().getDataBased().getWindTimeSeries().getFileName(),meteorologydat);
                        }else if (configuration.getMeteorologicalModel2D().getDataBased().getResultFile()!=null){
                            metModel = new SysErgInterpolatedMeteorologicalModel2D(feapp, base_dir+configuration.getMeteorologicalModel2D().getDataBased().getResultFile().getFileName(),meteorologydat);
                        }
                        if (metModel != null) {
                ...
                if( configuration.getBathymetricModel2D()!=null) {
                    ...
                    if(configuration.getBathymetricModel2D().getDataBased()!=null){
                        ...
                        if (configuration.getBathymetricModel2D().getDataBased().getResultFile()!=null){
                            bathymetricModel = new SysErgInterpolatedBathymetricModel2D(feapp, base_dir+configuration.getBathymetricModel2D().getDataBased().getResultFile().getFileName());
                        }
...
//--------------
                ...
                if (configuration.getCurrentModel2D() != null) {
                    ...
                    if (configuration.getCurrentModel2D().getBoundaryCondition() != null) { // Peter 08.01.2021
                        if (configuration.getCurrentModel2D().getBoundaryCondition().getFileType() == TCurrent2DBoundaryFileType.RNDWERTE_BAW) {
                            currentdat.rndwerte_name = base_dir + configuration.getCurrentModel2D().getBoundaryCondition().getFileName();
                    ...
                    if (configuration.getCurrentModel2D().getWeirFile()!=null){
                        if( configuration.getCurrentModel2D().getWeirFile().getFileType() == TWeirFileType.WEIRS_2_DXML){
                            currentdat.weirsFileType = CurrentDat.WeirFileType.weirXML;
                            currentdat.weirsFileName = base_dir+configuration.getCurrentModel2D().getWeirFile().getFileName();
                        }
                    }

                    if( configuration.getCurrentModel2D().getResultFile().getFileType() == TResultFileType.TICAD_SYS_ERG) {
                        currentdat.xferg_name=base_dir+configuration.getCurrentModel2D().getResultFile().getFileName();
                    }
                    ...
                    if (configuration.getCurrentModel2D().getBottomFriction() != null) {
                        if (configuration.getCurrentModel2D().getBottomFriction().getManningStrickler() != null) {
                            ...
                            if (configuration.getCurrentModel2D().getBottomFriction().getManningStrickler().getTriangleMesh() != null) {
                                if (configuration.getCurrentModel2D().getBottomFriction().getManningStrickler().getTriangleMesh().getFileType() == TMeshFileType.SYS_DAT_FILE) {
                                    currentdat.stricklerFileType = SmileIO.MeshFileType.SystemDat;
                                }
                                if (configuration.getCurrentModel2D().getBottomFriction().getManningStrickler().getTriangleMesh().getFileType() == TMeshFileType.JANET_BINARY_FILE) {
                            ...
                            if (configuration.getCurrentModel2D().getBottomFriction().getNikuradse().getTriangleMesh() != null) {
                                if (configuration.getCurrentModel2D().getBottomFriction().getNikuradse().getTriangleMesh().getFileType() == TMeshFileType.SYS_DAT_FILE) {
                                    currentdat.nikuradseFileType = SmileIO.MeshFileType.SystemDat;
                                }
                                if (configuration.getCurrentModel2D().getBottomFriction().getNikuradse().getTriangleMesh().getFileType() == TMeshFileType.JANET_BINARY_FILE) {
...
// @deprecated
                        ...
                        if( configuration.getCurrentModel2D().getBottomFriction().getTriangleMesh()!= null ) {
                            ...
                            if(configuration.getCurrentModel2D().getBottomFriction().getTriangleMesh().getFileType() == TMeshFileType.SYS_DAT_FILE)
                                currentdat.stricklerFileType=SmileIO.MeshFileType.SystemDat;
                            if(configuration.getCurrentModel2D().getBottomFriction().getTriangleMesh().getFileType() == TMeshFileType.JANET_BINARY_FILE)
                                currentdat.stricklerFileType=SmileIO.MeshFileType.JanetBin;
                            currentdat.strickler_name=base_dir+configuration.getCurrentModel2D().getBottomFriction().getTriangleMesh().getFileName();
                        }
...
// @deprecated
                        ...
                        System.out.println("\tnot specified roughness - constant Manning-Strickler value: "+currentdat.constantStrickler+" used!");
                    }
                    ...
                    } catch(Exception ex){/* System.out.println("no InfiltrationRate");*/}

                    try {
                        double latitude = configuration.getCurrentModel2D().getLatitude();
                        CurrentModel2D.setLatitude(latitude);
                        System.out.println("Latitude: lat=" + latitude + ", Coriolis Parameter: f=" + CurrentModel2D.getCoriolisParameter());
                    } catch (Exception ex) {
                    }
                    ...
                    if( configuration.getCurrentModel2D().getInitialCondition() != null ) {
                        ...
                        if( configuration.getCurrentModel2D().getInitialCondition().getStartFromResult() != null ) {
                            ...
                            currentdat.startWerteDatei=base_dir+configuration.getCurrentModel2D().getInitialCondition().getStartFromResult().getFileName();
                        ...
                        if( configuration.getCurrentModel2D().getInitialCondition().getWaterLevel() != null ) {
                            if ( configuration.getCurrentModel2D().getInitialCondition().getWaterLevel().getTriangleMesh()!=null){
...
//--------------
                ...
                if(configuration.getCurrentModel3D()!=null){
                    ...
                    if( configuration.getCurrentModel3D().getBoundaryCondition().getFileType() == TCurrent2DBoundaryFileType.RNDWERTE_BAW){
                        currentdat.rndwerte_name = base_dir+configuration.getCurrentModel3D().getBoundaryCondition().getFileName();
                        currentdat.rndwerteReader = new RndwerteBAWReader(currentdat.rndwerte_name,feapp);
                    }
                    
                    if( configuration.getCurrentModel3D().getResultFile2D()!=null)
                        if( configuration.getCurrentModel3D().getResultFile2D().getFileType() == TResultFileType.TICAD_SYS_ERG) {
                            currentdat.xferg_name=base_dir+configuration.getCurrentModel3D().getResultFile2D().getFileName();
                        }
                    if( configuration.getCurrentModel3D().getResultFile()!=null)
                        if( configuration.getCurrentModel3D().getResultFile().getFileType() == TResultFileType.CURRENT_3_D_ERG) {
                            currentdat.current3d_erg_name=base_dir+configuration.getCurrentModel3D().getResultFile().getFileName();
                        }
                    // Sind Rauheiten definiert ?
                    if( configuration.getCurrentModel3D().getBottomFriction()!= null ) {
                        if (configuration.getCurrentModel3D().getBottomFriction().getManningStrickler() != null) {
                            currentdat.bottomFriction = CurrentDat.BottomFriction.ManningStrickler;
                            if (configuration.getCurrentModel3D().getBottomFriction().getManningStrickler().getTriangleMesh() != null) {
                                if (configuration.getCurrentModel3D().getBottomFriction().getManningStrickler().getTriangleMesh().getFileType() == TMeshFileType.SYS_DAT_FILE) {
                                    currentdat.stricklerFileType = SmileIO.MeshFileType.SystemDat;
                                }
                                if (configuration.getCurrentModel3D().getBottomFriction().getManningStrickler().getTriangleMesh().getFileType() == TMeshFileType.JANET_BINARY_FILE) {
                                    currentdat.stricklerFileType = SmileIO.MeshFileType.JanetBin;
                                }
                        ...
                        if (configuration.getCurrentModel3D().getBottomFriction().getNikuradse() != null) {
                            currentdat.bottomFriction = CurrentDat.BottomFriction.Nikuradse;
                            if (configuration.getCurrentModel3D().getBottomFriction().getNikuradse().getTriangleMesh() != null) {
                                if (configuration.getCurrentModel3D().getBottomFriction().getNikuradse().getTriangleMesh().getFileType() == TMeshFileType.SYS_DAT_FILE) {
                                    currentdat.nikuradseFileType = SmileIO.MeshFileType.SystemDat;
                                }
                                if (configuration.getCurrentModel3D().getBottomFriction().getNikuradse().getTriangleMesh().getFileType() == TMeshFileType.JANET_BINARY_FILE) {
                                    currentdat.nikuradseFileType = SmileIO.MeshFileType.JanetBin;
                                }
                    ...
                    if( configuration.getCurrentModel3D().getInitialCondition() != null ) {
                        ...
                        if( configuration.getCurrentModel3D().getInitialCondition().getStartFromResult() != null ) {
                            if(configuration.getCurrentModel3D().getInitialCondition().getStartFromResult().getFileType()== TResultFileType.CURRENT_3_D_ERG){
                                currentdat.startWerte3DDatei=base_dir+configuration.getCurrentModel3D().getInitialCondition().getStartFromResult().getFileName();
                                currentdat.start3DSatz=configuration.getCurrentModel3D().getInitialCondition().getStartFromResult().getTimeStepCounter();
                            } else if(configuration.getCurrentModel3D().getInitialCondition().getStartFromResult().getFileType()== TResultFileType.TICAD_SYS_ERG){
                                currentdat.startWerteDatei=base_dir+configuration.getCurrentModel3D().getInitialCondition().getStartFromResult().getFileName();
                                currentdat.startSatz=configuration.getCurrentModel3D().getInitialCondition().getStartFromResult().getTimeStepCounter();
                            }
                        } else
                    // Ist ein Initialwasserstandsmodell vorhanden ?
                        if( configuration.getCurrentModel3D().getInitialCondition().getWaterLevel() != null ) {
                            if ( configuration.getCurrentModel3D().getInitialCondition().getWaterLevel().getTriangleMesh()!=null){
                ...
                if(configuration.getSedimentTransportModel2D()!=null){
                    ...
                    if (configuration.getSedimentTransportModel2D().getMaxErosion() != null) {
                        ...
                        if (configuration.getSedimentTransportModel2D().getMaxErosion().getTriangleMesh() != null) {
                            if (configuration.getSedimentTransportModel2D().getMaxErosion().getTriangleMesh().getFileType() == TMeshFileType.SYS_DAT_FILE) {
                                sedimentdat.maxerosionFileType = SmileIO.MeshFileType.SystemDat;
                            }
                            if (configuration.getSedimentTransportModel2D().getMaxErosion().getTriangleMesh().getFileType() == TMeshFileType.JANET_BINARY_FILE) {
                                sedimentdat.maxerosionFileType = SmileIO.MeshFileType.JanetBin;
                            }
                            sedimentdat.maxErosionFileName = base_dir + configuration.getSedimentTransportModel2D().getMaxErosion().getTriangleMesh().getFileName();
                            correct = true;
                            ...
                            sedimentdat.MaxErosionsTiefe = configuration.getSedimentTransportModel2D().getMaxErosion().getConstant();
                            correct = true;
                        }
                        if (!correct) {
                            System.exit(0);
                    ...
                    if (configuration.getSedimentTransportModel2D().getNoErodibleHorizon() != null) {
                        boolean correct = false;
                        // Ist ein Modell fuer erodierbare Tiefen gegeben ?
                        if (configuration.getSedimentTransportModel2D().getNoErodibleHorizon().getTriangleMesh() != null) {
                            if (configuration.getSedimentTransportModel2D().getNoErodibleHorizon().getTriangleMesh().getFileType() == TMeshFileType.SYS_DAT_FILE) {
                                sedimentdat.noErodibleHorizonFileType = SmileIO.MeshFileType.SystemDat;
                            }
                            if (configuration.getSedimentTransportModel2D().getNoErodibleHorizon().getTriangleMesh().getFileType() == TMeshFileType.JANET_BINARY_FILE) {
                                sedimentdat.noErodibleHorizonFileType = SmileIO.MeshFileType.JanetBin;
                            }
                            sedimentdat.noErodibleHorizonFileName = base_dir + configuration.getSedimentTransportModel2D().getNoErodibleHorizon().getTriangleMesh().getFileName();
                            correct = true;
                        } // Ist ein konstanter nicht erodiernbarer Horizont gegeben ?
                        else if (configuration.getSedimentTransportModel2D().getNoErodibleHorizon().getConstant() != null) {
                            sedimentdat.noErodibleHorizon = configuration.getSedimentTransportModel2D().getNoErodibleHorizon().getConstant();
                            correct = true;
                        }
                        if (!correct) {
                            System.exit(0);
                    ...
                    if (configuration.getSedimentTransportModel2D().getMaintainedDepth() != null) {
                        ...
                        if (configuration.getSedimentTransportModel2D().getMaintainedDepth().getTriangleMesh() != null) {
                            if (configuration.getSedimentTransportModel2D().getMaintainedDepth().getTriangleMesh().getFileType() == TMeshFileType.SYS_DAT_FILE) {
                                sedimentdat.maintainedDepthFileType = SmileIO.MeshFileType.SystemDat;
                            }
                            if (configuration.getSedimentTransportModel2D().getMaintainedDepth().getTriangleMesh().getFileType() == TMeshFileType.JANET_BINARY_FILE) {
                                sedimentdat.maintainedDepthFileType = SmileIO.MeshFileType.JanetBin;
                            }
                            sedimentdat.maintainedDepthFileName = base_dir + configuration.getSedimentTransportModel2D().getMaintainedDepth().getTriangleMesh().getFileName();
                            correct = true;
                        } // Ist eine konstante Baggertiefen gegeben ?
                        else if (configuration.getSedimentTransportModel2D().getMaintainedDepth().getConstant() != null) {
                            sedimentdat.maintainedDepth = configuration.getSedimentTransportModel2D().getMaintainedDepth().getConstant();
                            correct = true;
                        }
                        if (!correct) {
                            System.exit(0);
                    ...
                    if(configuration.getSedimentTransportModel2D().getBoundaryCondition()!=null)
                        if( configuration.getSedimentTransportModel2D().getBoundaryCondition().getFileType() == TSediment2DBoundaryFileType.RNDWERTE_BAW)
                            sedimentdat.rndwerte_name = base_dir+configuration.getSedimentTransportModel2D().getBoundaryCondition().getFileName();
                            sedimentdat.rndwerteReader = new RndwerteBAWReader(sedimentdat.rndwerte_name,feapp);

                    if( configuration.getSedimentTransportModel2D().getResultFile().getFileType() == TResultFileType.TICAD_SYS_ERG) {
                        sedimentdat.xferg_name=base_dir+configuration.getSedimentTransportModel2D().getResultFile().getFileName();
                    }
...
//                    *** SoilModel ***
                    if(configuration.getSedimentTransportModel2D().getSoilModel()!=null){
                        ...
                        if(configuration.getSedimentTransportModel2D().getSoilModel().getWriteModulo()!=null)
                            sedimentdat.modulo = configuration.getSedimentTransportModel2D().getSoilModel().getWriteModulo().intValue();
                        sedimentdat.SoilModel3DResultCoarsen = false;
                        try {
                            sedimentdat.SoilModel3DResultCoarsen = configuration.getSedimentTransportModel2D().getSoilModel().getInitialSoilModel().isCoarsen();
                        } catch (Exception e) {}
                        if(configuration.getSedimentTransportModel2D().getSoilModel().getInitialSoilModel()!=null){
                            sedimentdat.initialSoilModel3DDataFile = configuration.getSedimentTransportModel2D().getSoilModel().getInitialSoilModel().getFileName();
                            sedimentdat.initialSoilModel3DDataFileType = configuration.getSedimentTransportModel2D().getSoilModel().getInitialSoilModel().getFileType().value();
                        }
                    }

                    SedimentModel2D sedimentmodel = null;
                    if(currentmodel2D!=null) sedimentmodel = new SedimentModel2D(currentmodel2D, sedimentdat);
                    if(currentmodel3D!=null) sedimentmodel = new SedimentModel2D(currentmodel3D, sedimentdat);
                    ...
                    if (sedimentmodel != null) {
                        ...
                        if (configuration.getSedimentTransportModel2D().getInitialCondition() != null) {
                            ...
                            if (configuration.getSedimentTransportModel2D().getInitialCondition().getConcentration() != null) {
                                if (configuration.getSedimentTransportModel2D().getInitialCondition().getConcentration().getTriangleMesh() != null) {
                        ...
                        if (configuration.getSedimentTransportModel2D().getDuneParameter() != null) {
                            if (configuration.getSedimentTransportModel2D().getDuneParameter().getReadFromResult() != null) {
                                try {
                                    sedimentmodel.readDuneParameterFromTicadErgFile(base_dir + configuration.getSedimentTransportModel2D().getDuneParameter().getReadFromResult().getFileName(), configuration.getSedimentTransportModel2D().getDuneParameter().getReadFromResult().getTimeStepCounter());
                                } catch (Exception e) {
                                    System.out.println("\t !! Duenenparameter laesst sich nicht aus " + (base_dir + configuration.getSedimentTransportModel2D().getDuneParameter().getReadFromResult().getFileName()) + " einlesen !!");
                                    System.exit(0);
                                }

                            } else if (configuration.getSedimentTransportModel2D().getDuneParameter().getDuneHight().getTriangleMesh() != null) {
                                if (configuration.getSedimentTransportModel2D().getDuneParameter().getDuneHight().getTriangleMesh().getFileType() == TMeshFileType.SYS_DAT_FILE) {
                                    sedimentmodel.readDuneHightFromSysDat(base_dir + configuration.getSedimentTransportModel2D().getDuneParameter().getDuneHight().getTriangleMesh().getFileName());
                                }
                                if (configuration.getSedimentTransportModel2D().getDuneParameter().getDuneHight().getTriangleMesh().getFileType() == TMeshFileType.JANET_BINARY_FILE) {
                                    sedimentmodel.readDuneHightFromJanetBin(base_dir + configuration.getSedimentTransportModel2D().getDuneParameter().getDuneHight().getTriangleMesh().getFileName());
                                }
                            } else if (configuration.getSedimentTransportModel2D().getDuneParameter().getDuneHight().getConstant() != null) {
...
//                    *** SoilModel ***
                        if(sedimentdat.withSoilModel3DData){
                            if(configuration.getSedimentTransportModel2D().getSoilModel().getInitialSoilModel()!=null){
                                sedimentdat.initialSoilModel3DDataFile = base_dir + configuration.getSedimentTransportModel2D().getSoilModel().getInitialSoilModel().getFileName();
                                boolean coarsen = false;
                                try{
                                    coarsen = configuration.getSedimentTransportModel2D().getSoilModel().getInitialSoilModel().isCoarsen();
                                }catch(Exception e){}
                                if(configuration.getSedimentTransportModel2D().getSoilModel().getInitialSoilModel().getFileType() == TSoilModelFileType.CSV){
                                    sedimentmodel.readInitialSoilModel3DDataFromCVS(sedimentdat.initialSoilModel3DDataFile, coarsen);
                                }
                            }
                        }
...
//--------------
                if(configuration.getWaveHypModel()!=null){
                    ...
                    if( configuration.getWaveHypModel().getBoundaryCondition().getFileType() == TWaveBoundaryFileType.WAVE_RANDN_DAT){
                        wavehypdat.randn_name = base_dir+configuration.getWaveHypModel().getBoundaryCondition().getFileName();
                    }

                    if( configuration.getWaveHypModel().getResultFile().getFileType() == TResultFileType.TICAD_SYS_ERG) {
                        wavehypdat.xferg_name = base_dir+configuration.getWaveHypModel().getResultFile().getFileName();
                    }
                    ...
                    if( configuration.getWaveHypModel().getInitialCondition() != null ) {
                        ...
                        if( configuration.getWaveHypModel().getInitialCondition().getStartFromResult() != null ) {
                            // Die Unterscheidung in Dateiformate fehlt noch ...
                            wavehypdat.startWerteDatei=base_dir+configuration.getWaveHypModel().getInitialCondition().getStartFromResult().getFileName();
                            wavehypdat.startSatz=configuration.getWaveHypModel().getInitialCondition().getStartFromResult().getTimeStepCounter();
                        }
                    }

                    try{
                        wavehypdat.waterLevelOffSet = configuration.getWaveHypModel().getWaterLevelOffSet();
                    }catch(Exception ex){wavehypdat.waterLevelOffSet = 0.;}
...
//--------------
                if(configuration.getSaltTransportModel2D()!=null){
                    ...
                    if( configuration.getSaltTransportModel2D().getBoundaryCondition().getFileType() == TSalt2DBoundaryFileType.RNDWERTE_BAW){
                        saltdat.saltrndwerte_name = base_dir+configuration.getSaltTransportModel2D().getBoundaryCondition().getFileName();
                        saltdat.rndwerteReader = new RndwerteBAWReader(saltdat.saltrndwerte_name,feapp);
                    }


                    if( configuration.getSaltTransportModel2D().getResultFile().getFileType() == TResultFileType.TICAD_SYS_ERG) {
                        saltdat.xferg_name = base_dir+configuration.getSaltTransportModel2D().getResultFile().getFileName();
                    }

                    saltdat.NumberOfThreads =numberOfThreads;
                    SaltModel2D saltmodel=null;
                    if(currentmodel2D!=null) saltmodel = new SaltModel2D(currentmodel2D, saltdat);
                    else {
                    ...
                    if( configuration.getSaltTransportModel2D().getInitialCondition() != null ) {
                        ...
                        if( configuration.getSaltTransportModel2D().getInitialCondition().getConcentration() != null ) {
                            if ( configuration.getSaltTransportModel2D().getInitialCondition().getConcentration().getTriangleMesh()!=null){
...
//--------------
                if(configuration.getFluidMudFlowModel2D()!=null){
                    ...
                    if( configuration.getFluidMudFlowModel2D().getBoundaryCondition().getFileType() == TFluidMudFlow2DBoundaryFileType.RNDWERTE_BAW){
                        fluidMudDat.rndwerte_name = base_dir+configuration.getFluidMudFlowModel2D().getBoundaryCondition().getFileName();
                        fluidMudDat.rndwerteReader = new RndwerteBAWReader(fluidMudDat.rndwerte_name,feapp);

                    }

                    if( configuration.getFluidMudFlowModel2D().getResultFile().getFileType() == TResultFileType.TICAD_SYS_ERG) {
                        fluidMudDat.xferg_name=base_dir+configuration.getFluidMudFlowModel2D().getResultFile().getFileName();
                    }
                    ...
                    if( configuration.getFluidMudFlowModel2D().getInitialCondition() != null ) {
                        ...
                        if( configuration.getFluidMudFlowModel2D().getInitialCondition().getFluidMudLevel() != null ) {
                            ...
                            if ( configuration.getFluidMudFlowModel2D().getInitialCondition().getFluidMudLevel().getTriangleMesh()!=null){
                        ...
                        if( configuration.getFluidMudFlowModel2D().getDensity() != null ) {
                            ...
                            if ( configuration.getFluidMudFlowModel2D().getDensity().getTriangleMesh()!=null){
                                if(configuration.getFluidMudFlowModel2D().getDensity().getTriangleMesh().getFileType() == TMeshFileType.SYS_DAT_FILE){
                                    fluidMudDat.densityFileType=SmileIO.MeshFileType.SystemDat;
                                    fluidMudDat.density_name=base_dir+configuration.getFluidMudFlowModel2D().getDensity().getTriangleMesh().getFileName();
// ToDo                                    fluidMudErg = fluidMudModel2D.initialHfromSysDat(fluidMudDat.fluidmudlevel_name,startTime);
                                }
                                if(configuration.getFluidMudFlowModel2D().getDensity().getTriangleMesh().getFileType() == TMeshFileType.JANET_BINARY_FILE){
                                    fluidMudDat.densityFileType=SmileIO.MeshFileType.JanetBin;
                                    fluidMudDat.density_name=base_dir+configuration.getFluidMudFlowModel2D().getDensity().getTriangleMesh().getFileName();
// ToDo                                    fluidMudErg = fluidMudModel2D.initialHfromJanetBin(fluidMudDat.fluidmudlevel_name,startTime);
                                }
                            }
                            // Ist ein konstanter Density vorhanden ?
                                ...
                                fluidMudDat.constantDensity = configuration.getFluidMudFlowModel2D().getDensity().getConstant();
                            }
                        }
                        ...
                        if( configuration.getFluidMudFlowModel2D().getViscosity() != null ) {
                            ...
                            if ( configuration.getFluidMudFlowModel2D().getViscosity().getTriangleMesh()!=null){
                                if(configuration.getFluidMudFlowModel2D().getViscosity().getTriangleMesh().getFileType() == TMeshFileType.SYS_DAT_FILE){
                                    fluidMudDat.fluidmudLevelFileType=SmileIO.MeshFileType.SystemDat;
                                    fluidMudDat.fluidmudlevel_name=base_dir+configuration.getFluidMudFlowModel2D().getViscosity().getTriangleMesh().getFileName();
// ToDo                                    fluidMudErg = fluidMudModel2D.initialHfromSysDat(fluidMudDat.fluidmudlevel_name,startTime);
                                }
                                if(configuration.getFluidMudFlowModel2D().getViscosity().getTriangleMesh().getFileType() == TMeshFileType.JANET_BINARY_FILE){
                                    fluidMudDat.fluidmudLevelFileType=SmileIO.MeshFileType.JanetBin;
                                    fluidMudDat.fluidmudlevel_name=base_dir+configuration.getFluidMudFlowModel2D().getViscosity().getTriangleMesh().getFileName();
// ToDo                                    fluidMudErg = fluidMudModel2D.initialHfromJanetBin(fluidMudDat.fluidmudlevel_name,startTime);
                                }
                            ...
                            System.out.println("Lese konstanten Viscosity!");
                              fluidMudDat.constantViscosity = configuration.getFluidMudFlowModel2D().getViscosity().getConstant();
                            }
                        }
...
//--------------
                if(configuration.getAdvectionDispersionModel2D()!=null){
                    ...
                    if( configuration.getAdvectionDispersionModel2D().getBoundaryCondition().getFileType() == TAdvectionDispersion2DBoundaryFileType.RNDWERTE_BAW){
                        admdat.adrndwerte_name = base_dir+configuration.getAdvectionDispersionModel2D().getBoundaryCondition().getFileName();
                        admdat.rndwerteReader = new RndwerteBAWReader(admdat.adrndwerte_name,feapp);
                    }


                    if( configuration.getAdvectionDispersionModel2D().getResultFile().getFileType() == TResultFileType.TICAD_SYS_ERG) {
                        admdat.xferg_name = base_dir+configuration.getAdvectionDispersionModel2D().getResultFile().getFileName();
                    }

                    admdat.NumberOfThreads =numberOfThreads;

                    try{
                        admdat.dispersionCoefficient = configuration.getAdvectionDispersionModel2D().getDispersionCoefficient();
                    } catch(Exception ex){System.out.println("no extra DispersionCoefficient");}

                    try{
                        admdat.degradationRate =configuration.getAdvectionDispersionModel2D().getDegradationRate();
                    } catch(Exception ex){ System.out.println("no DegradationRate");}
                    ...
                    if( configuration.getAdvectionDispersionModel2D().getInitialCondition() != null ) {
                        ...
                        // Ist ein Initialkonzentrationsmodell vorhanden ?
                        if( configuration.getAdvectionDispersionModel2D().getInitialCondition().getConcentration() != null ) {
                            if ( configuration.getAdvectionDispersionModel2D().getInitialCondition().getConcentration().getTriangleMesh()!=null){
...
//--------------
                if(configuration.getHeatTransportModel2D()!=null){
                    ...
                    if( configuration.getHeatTransportModel2D().getResultFile().getFileType() == TResultFileType.TICAD_SYS_ERG) {
                        heatTdat.xferg_name = base_dir+configuration.getHeatTransportModel2D().getResultFile().getFileName();
                    }

                    if( configuration.getHeatTransportModel2D().getBoundaryCondition().getFileType() == THeat2DBoundaryFileType.RNDWERTE_BAW){
                        heatTdat.temperaturerndwerte_name = base_dir+configuration.getHeatTransportModel2D().getBoundaryCondition().getFileName();
                    ...
                    if( configuration.getHeatTransportModel2D().getInitialCondition() != null ) {
                        ...
                        if( configuration.getHeatTransportModel2D().getInitialCondition().getTemperature() != null ) {
                            if ( configuration.getHeatTransportModel2D().getInitialCondition().getTemperature().getTriangleMesh()!=null){
...
//--------------
                if(configuration.getGroundWaterModel2D()!=null){
                    ...
                    if( configuration.getGroundWaterModel2D().getBoundaryCondition().getFileType() == TGroundWater2DBoundaryFileType.RNDWERTE_BAW){
                        groundwaterdat.rndwerte_name = base_dir+configuration.getGroundWaterModel2D().getBoundaryCondition().getFileName();
                        groundwaterdat.rndwerteReader = new RndwerteBAWReader(groundwaterdat.rndwerte_name,feapp);
                    }

                    if( configuration.getGroundWaterModel2D().getResultFile().getFileType() == TResultFileType.TICAD_SYS_ERG) {
                        groundwaterdat.xferg_name=base_dir+configuration.getGroundWaterModel2D().getResultFile().getFileName();
                    }
                    ...
                    if( configuration.getGroundWaterModel2D().getPermeability()!= null ) {
                        ...
                        if( configuration.getGroundWaterModel2D().getPermeability().getTriangleMesh()!= null ) {
                            if(configuration.getGroundWaterModel2D().getPermeability().getTriangleMesh().getFileType() == TMeshFileType.SYS_DAT_FILE)
                                groundwaterdat.permeability_FileType=SmileIO.MeshFileType.SystemDat;
                            if(configuration.getGroundWaterModel2D().getPermeability().getTriangleMesh().getFileType() == TMeshFileType.JANET_BINARY_FILE)
                                 groundwaterdat.permeability_FileType=SmileIO.MeshFileType.JanetBin;
                           groundwaterdat.permeability_name=base_dir+configuration.getGroundWaterModel2D().getPermeability().getTriangleMesh().getFileName();
                        }
                        // Ist eine konstante Permeabilitaetsverteilung gegeben ?
                            ...
                            groundwaterdat.standardPermeability = configuration.getGroundWaterModel2D().getPermeability().getConstant();
                        }
                    } else {
                        System.out.println("Keine Werte fuer Permeabiliaet gegeben (Standardwert = "+groundwaterdat.standardPermeability+")!");
                    }

                    // Sind Impermeabilitaetstiefen definiert ?
                    if( configuration.getGroundWaterModel2D().getImpermeableLayerDepth()!= null ) {
                        // Ist ein Modell fuer Permeabilitaeten gegeben ?
                        if( configuration.getGroundWaterModel2D().getImpermeableLayerDepth().getTriangleMesh()!= null ) {
                            if(configuration.getGroundWaterModel2D().getImpermeableLayerDepth().getTriangleMesh().getFileType() == TMeshFileType.SYS_DAT_FILE)
                                groundwaterdat.impermeability_FileType=SmileIO.MeshFileType.SystemDat;
                            if(configuration.getGroundWaterModel2D().getImpermeableLayerDepth().getTriangleMesh().getFileType() == TMeshFileType.JANET_BINARY_FILE)
                                 groundwaterdat.impermeability_FileType=SmileIO.MeshFileType.JanetBin;
                           groundwaterdat.impermeability_name=base_dir+configuration.getGroundWaterModel2D().getImpermeableLayerDepth().getTriangleMesh().getFileName();
                        }
                        // Ist eine konstante Impermeabilitaetsverteilung gegeben ?
                        else if( configuration.getGroundWaterModel2D().getImpermeableLayerDepth().getConstant()!= null ) {
                            groundwaterdat.standardImpermeability = configuration.getGroundWaterModel2D().getImpermeableLayerDepth().getConstant();
                        }
                    } else {
                    ...
                    if( configuration.getGroundWaterModel2D().getUpperImpermeableLayerThickness()!= null ) {
                        // Ist ein Modell fuer Permeabilitaeten gegeben ?
                        if( configuration.getGroundWaterModel2D().getUpperImpermeableLayerThickness().getTriangleMesh()!= null ) {
                            if(configuration.getGroundWaterModel2D().getUpperImpermeableLayerThickness().getTriangleMesh().getFileType() == TMeshFileType.SYS_DAT_FILE)
                                groundwaterdat.upperImpermeabilityThickness_FileType=SmileIO.MeshFileType.SystemDat;
                            if(configuration.getGroundWaterModel2D().getUpperImpermeableLayerThickness().getTriangleMesh().getFileType() == TMeshFileType.JANET_BINARY_FILE)
                                 groundwaterdat.upperImpermeabilityThickness_FileType=SmileIO.MeshFileType.JanetBin;
                           groundwaterdat.upperImpermeabilityThickness_name=base_dir+configuration.getGroundWaterModel2D().getUpperImpermeableLayerThickness().getTriangleMesh().getFileName();
                        }
                        // Ist eine konstante Impermeabilitaetsverteilung gegeben ?
                        else if( configuration.getGroundWaterModel2D().getUpperImpermeableLayerThickness().getConstant()!= null ) {
                            groundwaterdat.standartUpperImpermeabilityThickness = configuration.getGroundWaterModel2D().getUpperImpermeableLayerThickness().getConstant();
                        }
                    } else {
                        System.out.println("Keine Werte fuer Deckschichtdicke gegeben (Standardwert = 0m)!");
                    }

                    // ist OberflaechenWasserStand gegeben? aber nur wenn kein oberflaechenmodell aktiviert ist
                    if( (configuration.getGroundWaterModel2D().getSurfaceWater()!= null) && (configuration.getCurrentModel2D()==null) ) {
                        if( configuration.getGroundWaterModel2D().getSurfaceWater().getTriangleMesh()!= null ) {
                            if(configuration.getGroundWaterModel2D().getSurfaceWater().getTriangleMesh().getFileType() == TMeshFileType.SYS_DAT_FILE)
                                groundwaterdat.surfaceWater_FileType=SmileIO.MeshFileType.SystemDat;
                            if(configuration.getGroundWaterModel2D().getSurfaceWater().getTriangleMesh().getFileType() == TMeshFileType.JANET_BINARY_FILE)
                                 groundwaterdat.surfaceWater_FileType=SmileIO.MeshFileType.JanetBin;
                           groundwaterdat.surfaceWater_name=base_dir+configuration.getGroundWaterModel2D().getSurfaceWater().getTriangleMesh().getFileName();
                        }
                    } else {
                    ...
                    if( configuration.getGroundWaterModel2D().getInitialCondition() != null ) {
                        ...
                        if( configuration.getGroundWaterModel2D().getInitialCondition().getWaterLevel() != null ) {
                          if ( configuration.getGroundWaterModel2D().getInitialCondition().getWaterLevel().getTriangleMesh()!=null){
                        ...
                        // Ist ein konstanter Initialwasserstand vorhanden ?
                        else if( configuration.getGroundWaterModel2D().getInitialCondition().getWaterLevel().getConstant() != null ) {
...
//--------------
                if(configuration.getSpartinaAlternifloraModel2D()!=null){
                    ...
                    if( configuration.getSpartinaAlternifloraModel2D().getResultFile().getFileType() == TResultFileType.TICAD_SYS_ERG) {
                        heatTdat.xferg_name = base_dir+configuration.getSpartinaAlternifloraModel2D().getResultFile().getFileName();
                    }
                    ...
                    if( configuration.getSpartinaAlternifloraModel2D().getInitialCondition() != null ) {
                        // Ist eine Startdatei vorhanden ?
                        if( configuration.getSpartinaAlternifloraModel2D().getInitialCondition().getStartFromResult() != null ) {
                            heatTdat.startWerteDatei = base_dir+configuration.getHeatTransportModel2D().getInitialCondition().getStartFromResult().getFileName();
                            heatTdat.startSatz = configuration.getHeatTransportModel2D().getInitialCondition().getStartFromResult().getTimeStepCounter();
                        } else
                        // Ist ein InitialDichtemodell vorhanden ?
                        if( configuration.getSpartinaAlternifloraModel2D().getInitialCondition().getDensity() != null ) {
                            if ( configuration.getSpartinaAlternifloraModel2D().getInitialCondition().getDensity().getTriangleMesh()!=null){
                                if(configuration.getSpartinaAlternifloraModel2D().getInitialCondition().getDensity().getTriangleMesh().getFileType() == TMeshFileType.SYS_DAT_FILE){
                                    heatTdat.densityFileType=SmileIO.MeshFileType.SystemDat;
                                    heatTdat.desity_name=base_dir+configuration.getSpartinaAlternifloraModel2D().getInitialCondition().getDensity().getTriangleMesh().getFileName();
                                }
                                if(configuration.getSpartinaAlternifloraModel2D().getInitialCondition().getDensity().getTriangleMesh().getFileType() == TMeshFileType.JANET_BINARY_FILE){
                            ...
                            else if( configuration.getSpartinaAlternifloraModel2D().getInitialCondition().getDensity().getConstant() != null ) {
                              heatTdat.startDensity = configuration.getSpartinaAlternifloraModel2D().getInitialCondition().getDensity().getConstant();
                            }
                        }
                    }
...
//--------------
                if(configuration.getOxygenTransportModel2D()!=null){
                    ...
                    if( configuration.getOxygenTransportModel2D().getBoundaryCondition().getFileType() == TQxygen2DBoundaryFileType.RNDWERTE_BAW){
                       oxygendat.oxygenrndwerte_name = base_dir+configuration.getOxygenTransportModel2D().getBoundaryCondition().getFileName();
                       oxygendat.rndwerteReader = new RndwerteBAWReader(oxygendat.oxygenrndwerte_name,feapp);
                    }


                    if( configuration.getOxygenTransportModel2D().getResultFile().getFileType() == TResultFileType.TICAD_SYS_ERG) {
                        oxygendat.xferg_name=base_dir+configuration.getOxygenTransportModel2D().getResultFile().getFileName();
                    }
                    ...
                    if( configuration.getOxygenTransportModel2D().getInitialCondition() != null ) {
                        // Ist eine Startdatei vorhanden ?
                        if( configuration.getOxygenTransportModel2D().getInitialCondition().getStartFromResult() != null ) {
                            // Die Unterscheidung in Dateiformate fehlt noch ...
                            oxygendat.initalValuesErgFile=base_dir+configuration.getOxygenTransportModel2D().getInitialCondition().getStartFromResult().getFileName();
                            oxygendat.startCounter=configuration.getOxygenTransportModel2D().getInitialCondition().getStartFromResult().getTimeStepCounter();
                        }else
                        // Ist ein Initialkonzentrationsmodell vorhanden ?
                        if( configuration.getOxygenTransportModel2D().getInitialCondition().getConcentration() != null ) {
                          if ( configuration.getOxygenTransportModel2D().getInitialCondition().getConcentration().getTriangleMesh()!=null){
                                if(configuration.getOxygenTransportModel2D().getInitialCondition().getConcentration().getTriangleMesh().getFileType() == TMeshFileType.SYS_DAT_FILE){
                                    oxygendat.concentrationFileType=SmileIO.MeshFileType.SystemDat;
                                    oxygendat.concentration_name=base_dir+configuration.getOxygenTransportModel2D().getInitialCondition().getConcentration().getTriangleMesh().getFileName();
                                   // nitraterg = nitratmodel.initialConcentrationFromSysDat(nitratdat.concentration_name,startTime);
                                }
                                if(configuration.getOxygenTransportModel2D().getInitialCondition().getConcentration().getTriangleMesh().getFileType() == TMeshFileType.JANET_BINARY_FILE){
                                    oxygendat.concentrationFileType=SmileIO.MeshFileType.JanetBin;
                                    oxygendat.concentration_name=base_dir+configuration.getOxygenTransportModel2D().getInitialCondition().getConcentration().getTriangleMesh().getFileName();
                                   // nitraterg = nitratmodel.initialConcentrationFromJanetBin(nitratdat.concentration_name,startTime);
                                }
                            }
...
//--------------
                if(configuration.getNitratTransportModel2D()!=null){
                    ...
                    if( configuration.getNitratTransportModel2D().getBoundaryCondition().getFileType() == TEco2DBoundaryFileType.ECO_BOUNDARY_DAT){
                       nitratdat.rndwerte_name = base_dir+configuration.getNitratTransportModel2D().getBoundaryCondition().getFileName();
                    }


                    if( configuration.getNitratTransportModel2D().getResultFile().getFileType() == TResultFileType.TICAD_SYS_ERG) {
                        nitratdat.xferg_name=base_dir+configuration.getNitratTransportModel2D().getResultFile().getFileName();
                    }
                    ...
                    if( configuration.getNitratTransportModel2D().getInitialCondition() != null ) {
                        // Ist eine Startdatei vorhanden ?
                        if( configuration.getNitratTransportModel2D().getInitialCondition().getStartFromResult() != null ) {
                            // Die Unterscheidung in Dateiformate fehlt noch ...
                            nitratdat.startWerteDatei=base_dir+configuration.getNitratTransportModel2D().getInitialCondition().getStartFromResult().getFileName();
                            nitratdat.startSatz=configuration.getNitratTransportModel2D().getInitialCondition().getStartFromResult().getTimeStepCounter();
                           // nitraterg = nitratmodel.initialSolutionFromTicadErgFile(nitratdat.startWerteDatei, nitratdat.startSatz);
                        }else
                        // Ist ein Initialkonzentrationsmodell vorhanden ?
                        if( configuration.getNitratTransportModel2D().getInitialCondition().getConcentration() != null ) {
                          if ( configuration.getNitratTransportModel2D().getInitialCondition().getConcentration().getTriangleMesh()!=null){
                                if(configuration.getNitratTransportModel2D().getInitialCondition().getConcentration().getTriangleMesh().getFileType() == TMeshFileType.SYS_DAT_FILE){
                                    nitratdat.concentrationFileType=SmileIO.MeshFileType.SystemDat;
                                    nitratdat.concentration_name=base_dir+configuration.getNitratTransportModel2D().getInitialCondition().getConcentration().getTriangleMesh().getFileName();
                                   // nitraterg = nitratmodel.initialConcentrationFromSysDat(nitratdat.concentration_name,startTime);
                                }
                                if(configuration.getNitratTransportModel2D().getInitialCondition().getConcentration().getTriangleMesh().getFileType() == TMeshFileType.JANET_BINARY_FILE){
...
//--------------
                if(configuration.getPhytoplanktonTransportModel2D()!=null){
                    ...
                    if( configuration.getPhytoplanktonTransportModel2D().getBoundaryCondition().getFileType() == TEco2DBoundaryFileType.ECO_BOUNDARY_DAT){
                       phytodat.phyto_rndwerteName = base_dir+configuration.getPhytoplanktonTransportModel2D().getBoundaryCondition().getFileName();
                    }


                    if( configuration.getPhytoplanktonTransportModel2D().getResultFile().getFileType() == TResultFileType.TICAD_SYS_ERG) {
                        phytodat.xferg_name=base_dir+configuration.getPhytoplanktonTransportModel2D().getResultFile().getFileName();
                    }
                    ...
                    if( configuration.getPhytoplanktonTransportModel2D().getInitialCondition() != null ) {
                        // Ist eine Startdatei vorhanden ?
                        if( configuration.getPhytoplanktonTransportModel2D().getInitialCondition().getStartFromResult() != null ) {
                            System.out.println("Lese Startdatei!");
                            // Die Unterscheidung in Dateiformate fehlt noch ...
                            phytodat.startWerteDatei=base_dir+configuration.getPhytoplanktonTransportModel2D().getInitialCondition().getStartFromResult().getFileName();
                            phytodat.startSatz=configuration.getPhytoplanktonTransportModel2D().getInitialCondition().getStartFromResult().getTimeStepCounter();
                           // phytoerg = phytomodel.initialSolutionFromTicadErgFile(phytodat.startWerteDatei, phytodat.startSatz);
                        }else
                        // Ist ein Initialkonzentrationsmodell vorhanden ?
                        if( configuration.getPhytoplanktonTransportModel2D().getInitialCondition().getConcentration() != null ) {
                          System.out.println("Lese Startkonzentrationsmodell!");
                          if ( configuration.getPhytoplanktonTransportModel2D().getInitialCondition().getConcentration().getTriangleMesh()!=null){
                                if(configuration.getPhytoplanktonTransportModel2D().getInitialCondition().getConcentration().getTriangleMesh().getFileType() == TMeshFileType.SYS_DAT_FILE){
                                    phytodat.concentrationFileType=SmileIO.MeshFileType.SystemDat;
                                    phytodat.concentration_name=base_dir+configuration.getPhytoplanktonTransportModel2D().getInitialCondition().getConcentration().getTriangleMesh().getFileName();
                                   // phytoerg = phytomodel.initialConcentrationFromSysDat(phytodat.concentration_name,startTime);
                                }
                                if(configuration.getPhytoplanktonTransportModel2D().getInitialCondition().getConcentration().getTriangleMesh().getFileType() == TMeshFileType.JANET_BINARY_FILE){
                                    phytodat.concentrationFileType=SmileIO.MeshFileType.JanetBin;
                                    phytodat.concentration_name=base_dir+configuration.getPhytoplanktonTransportModel2D().getInitialCondition().getConcentration().getTriangleMesh().getFileName();
                                   // phytoerg = phytomodel.initialConcentrationFromJanetBin(phytodat.concentration_name,startTime);
                                }
                            }
...
//--------------
                if(configuration.getZooplanktonTransportModel2D()!=null){
                    ...
                    if( configuration.getZooplanktonTransportModel2D().getBoundaryCondition().getFileType() == TEco2DBoundaryFileType.ECO_BOUNDARY_DAT){
                       zoodat.zoo_rndwerteName = base_dir+configuration.getZooplanktonTransportModel2D().getBoundaryCondition().getFileName();
                    }


                    if( configuration.getZooplanktonTransportModel2D().getResultFile().getFileType() == TResultFileType.TICAD_SYS_ERG) {
                        zoodat.xferg_name=base_dir+configuration.getZooplanktonTransportModel2D().getResultFile().getFileName();
                    }
                    ...
                    if( configuration.getZooplanktonTransportModel2D().getInitialCondition() != null ) {
                        // Ist eine Startdatei vorhanden ?
                        if( configuration.getZooplanktonTransportModel2D().getInitialCondition().getStartFromResult() != null ) {
                            System.out.println("Lese Startdatei!");
                            // Die Unterscheidung in Dateiformate fehlt noch ...
                            zoodat.startWerteDatei=base_dir+configuration.getZooplanktonTransportModel2D().getInitialCondition().getStartFromResult().getFileName();
                            zoodat.startSatz=configuration.getZooplanktonTransportModel2D().getInitialCondition().getStartFromResult().getTimeStepCounter();
                           // Zooerg = Zoomodel.initialSolutionFromTicadErgFile(Zoodat.startWerteDatei, Zoodat.startSatz);
                        }else
                        // Ist ein Initialkonzentrationsmodell vorhanden ?
                        if( configuration.getZooplanktonTransportModel2D().getInitialCondition().getConcentration() != null ) {
                          System.out.println("Lese Startkonzentrationsmodell!");
                          if ( configuration.getZooplanktonTransportModel2D().getInitialCondition().getConcentration().getTriangleMesh()!=null){
                                if(configuration.getZooplanktonTransportModel2D().getInitialCondition().getConcentration().getTriangleMesh().getFileType() == TMeshFileType.SYS_DAT_FILE){
                                    zoodat.concentrationFileType=SmileIO.MeshFileType.SystemDat;
                                    zoodat.concentration_name=base_dir+configuration.getZooplanktonTransportModel2D().getInitialCondition().getConcentration().getTriangleMesh().getFileName();
                                   // Zooerg = Zoomodel.initialConcentrationFromSysDat(Zoodat.concentration_name,startTime);
                                }
                                if(configuration.getZooplanktonTransportModel2D().getInitialCondition().getConcentration().getTriangleMesh().getFileType() == TMeshFileType.JANET_BINARY_FILE){
                                    zoodat.concentrationFileType=SmileIO.MeshFileType.JanetBin;
                                    zoodat.concentration_name=base_dir+configuration.getZooplanktonTransportModel2D().getInitialCondition().getConcentration().getTriangleMesh().getFileName();
                                   // Zooerg = Zoomodel.initialConcentrationFromJanetBin(Zoodat.concentration_name,startTime);
                                }
                            }


                        // Ist eine konstante Konzentration vorhanden ?
                        else if( configuration.getZooplanktonTransportModel2D().getInitialCondition().getConcentration().getConstant() != null ) {
...
//--------------
                if(configuration.getDetritusTransportModel2D()!=null){
                    ...
                    if( configuration.getDetritusTransportModel2D().getBoundaryCondition().getFileType() == TEco2DBoundaryFileType.ECO_BOUNDARY_DAT){
                       detritusdat.detrit_rndwerteName = base_dir+configuration.getDetritusTransportModel2D().getBoundaryCondition().getFileName();
                    }


                    if( configuration.getDetritusTransportModel2D().getResultFile().getFileType() == TResultFileType.TICAD_SYS_ERG) {
                        detritusdat.xferg_name=base_dir+configuration.getDetritusTransportModel2D().getResultFile().getFileName();
                    }
                    ...
                    if( configuration.getDetritusTransportModel2D().getInitialCondition() != null ) {
                        // Ist eine Startdatei vorhanden ?
                        if( configuration.getDetritusTransportModel2D().getInitialCondition().getStartFromResult() != null ) {
                            // Die Unterscheidung in Dateiformate fehlt noch ...
                            detritusdat.startWerteDatei=base_dir+configuration.getDetritusTransportModel2D().getInitialCondition().getStartFromResult().getFileName();
                            detritusdat.startSatz=configuration.getDetritusTransportModel2D().getInitialCondition().getStartFromResult().getTimeStepCounter();
                           // Zooerg = Zoomodel.initialSolutionFromTicadErgFile(Zoodat.startWerteDatei, Zoodat.startSatz);
                        }else
                        // Ist ein Initialkonzentrationsmodell vorhanden ?
                        if( configuration.getDetritusTransportModel2D().getInitialCondition().getConcentration() != null ) {
                          if ( configuration.getDetritusTransportModel2D().getInitialCondition().getConcentration().getTriangleMesh()!=null){
                                if(configuration.getDetritusTransportModel2D().getInitialCondition().getConcentration().getTriangleMesh().getFileType() == TMeshFileType.SYS_DAT_FILE){
                                    detritusdat.concentrationFileType=SmileIO.MeshFileType.SystemDat;
                                    detritusdat.concentration_name=base_dir+configuration.getDetritusTransportModel2D().getInitialCondition().getConcentration().getTriangleMesh().getFileName();
                                   // Zooerg = Zoomodel.initialConcentrationFromSysDat(Zoodat.concentration_name,startTime);
                                }
                                if(configuration.getDetritusTransportModel2D().getInitialCondition().getConcentration().getTriangleMesh().getFileType() == TMeshFileType.JANET_BINARY_FILE){
