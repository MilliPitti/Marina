...
//        double CSF = smd.CSF; // variable
        ...
        double sfx = ((smd.bedDragCoeff * cmd.u) * cmd.wlambda * PhysicalParameters.RHO_WATER + dzdx * PhysicalParameters.G * Math.PI*Math.pow(smd.d50,3.)/6.*(PhysicalParameters.RHO_SEDIM - PhysicalParameters.RHO_WATER) + smd.tau_bx_extra) / ((PhysicalParameters.RHO_SEDIM - PhysicalParameters.RHO_WATER) * PhysicalParameters.G * smd.d50);
        double sfy = ((smd.bedDragCoeff * cmd.v) * cmd.wlambda * PhysicalParameters.RHO_WATER + dzdy * PhysicalParameters.G * Math.PI*Math.pow(smd.d50,3.)/6.*(PhysicalParameters.RHO_SEDIM - PhysicalParameters.RHO_WATER) + smd.tau_by_extra) / ((PhysicalParameters.RHO_SEDIM - PhysicalParameters.RHO_WATER) * PhysicalParameters.G * smd.d50);
