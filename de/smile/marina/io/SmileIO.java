...
public class SmileIO {
    ...
    public static enum MeshFileType {JanetBin, SystemDat};
    public static enum ResultFileType  {SysErg, Current3DErg};
    public static enum BoundaryConditionFileType {BAWFormat};
    
    /** Creates a new instance of SmileIO */
    public SmileIO() {
    }
    
    /** Lesen eines Objekts der Klasse TopoElementMesh aus einer Datei im Binaerformat mit
    ...
    public static FEDecomposition readFEDfromJanetBin( String filename) //throws Exception
    {
        ...
        try {
            ...
            if (version<1.5f) {
                System.out.println("Deprecated version of Janet-Binary-Format, version found: "+version+", current version: 1.8");
                return null;
            ...
            for (int i=0; i<anzk; i++) {
                ...
                if(hasHeights) z*=-1.; // Peter 05.04.2016 wenn Hoehen dann auf Tiefen umrechnen
