    ...
    public final double ElementApproximation(FElement element) {
        ...
        if (dry == 3) { // element is totaly dry
            ...
            for (int j = 0; j < 3; j++) {
                ...
                final double result_H_i = rH[j];   // Kontinuitaet: SUPG- und Galerkin-Anteil mit gl-Gewichtung, siehe oben
...
//        }
    ...
    public final void timeStep(double dt) {
        ...
        Arrays.stream(fenet.getDOFs()).parallel().forEach(dof -> {
            ...
            reta += source_dhdt;
            reta -= infiltrationRate * (1. - cmd.puddleLambda); // Versickern in Pfuezen
