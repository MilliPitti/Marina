...
public class FileIO {
    ...
    /**
        Lesen einer Fliesskommazahl (double) im Little-Endian-Mode von Datei (Binary).
     */
	...
	/**
	Oeffnen einer Datei zum Lesen oder Schreiben. Zusaetzlich wird ein Kommentarzeichen angegeben.
	 */
